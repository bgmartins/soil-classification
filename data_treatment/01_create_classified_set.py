...
threshold = 0.01
h = '01_create_classified_set.py -h <help> -p <profile file> -l <layers file> -t <threshold to remove columns(default 0.01)> -o <outputfile> '

try:
    opts, args = getopt.getopt(sys.argv[1:], "hp:l:t:o:")
...
classified_data = classified_data.drop(columns=['dataset_id', 'cfao_version', 'cfao_major_group',
...
# Remove all columns less than the threshold
