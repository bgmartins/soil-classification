...
class MultiplicativeLSTM(Recurrent):
    ...
    def step(self, inputs, states):
        ...
        if self.implementation == 2:
            ...
            # applies m instead of h_tm1 to z
            z += z * K.dot(h_tm1 * rec_dp_mask[0], self.recurrent_kernel)
            if self.use_bias:
            ...
            # just elementwise multiplication, no activation functions
            z4 = z[:, 4 * self.units:]
            ...
            # elementwise multiplication m
            m = x_m * K.dot(h_tm1 * rec_dp_mask[4], self.recurrent_kernel_m)
